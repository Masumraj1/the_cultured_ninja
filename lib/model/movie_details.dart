...
class MovieDetails {
  ...
  factory MovieDetails.fromRawJson(String str) => MovieDetails.fromJson(json.decode(str));
...
class DetailsData {
  ...
  factory DetailsData.fromJson(Map<String, dynamic> json) => DetailsData(
    ...
    trailer: json["trailer"] == null ? [] : List<Trailer>.from(json["trailer"]!.map((x) => Trailer.fromJson(x))),
    platform: json["platform"] == null ? [] : List<Platform>.from(json["platform"]!.map((x) => Platform.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "details": details?.toJson(),
    "trailer": trailer == null ? [] : List<dynamic>.from(trailer!.map((x) => x.toJson())),
    "platform": platform == null ? [] : List<dynamic>.from(platform!.map((x) => x.toJson())),
